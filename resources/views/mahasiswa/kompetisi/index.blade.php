...
<div class="row">
    ...
    <div class="col-lg-4 col-12 mt-3">
        <div class="input-group input-underline">
            ...
            <input id="exampleFormControlInput1" type="email" placeholder="Cari Kompetisi" class="form-control form-control-underlined">
        </div>
    </div>
</div>
        ...
        <div class="">
            <div class="tab">
                <ul class="nav nav-tabs customtab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active  pb-2" data-toggle="tab" href="#home2" role="tab" aria-selected="true">Kompetisi Aktif</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  pb-2" data-toggle="tab" href="#profile2" role="tab" aria-selected="false">Kompetisi Favorit</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link  pb-2" data-toggle="tab" href="#contact2" role="tab" aria-selected="false">Kompetisi Lalu</a>
                    </li>
                </ul>
                            ...
                            <div class="row mt-5">
                                <div class="col-sm-12 col-md-6 col-lg-4 mb-30">
                                    <div class="card card-box" style="position: relative">
                                        ...
                                        <img class="card-img-top" src="{{url('assets/img/kompetisi-thumb/thumbnail.jpg')}}" alt="Card image cap">
                                        <div class="card-body">
                                            <h5 class="card-title weight-500"><a href="{{route('mahasiswa.kompetisi.detail','Design-Competition')}}">Design Competition</a></h5>
                                            <p class="card-text">This is a wider card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.</p>
                                            <p class="card-text"><small class="text-muted">Terdaftar 3 hari lalu</small></p>
                                        </div>
                                    </div>
