                        ...
                        <div class="row">
                            ...
                            <div class="col-6 text-right">
                                <div id="container-btn">
                                    <a href="{{route('ormawa.eventeksternal.index')}}" id="tambah-btn"
                        ...
                        <div class="row">
                            <div class="col-lg-12 mb-3">
                                <div class="ormawa-banner_inp_profil shadow-sm mb-1">
                                    <img data-filename="{{$eeJson}}"
                                        src="{{url('assets/img/banner-komp/'.$ee->banner_image)}}" id="banner-image"
                            ...
                            <div class="col-lg-8 col-12">
                                <form action="{{route('ormawa.eventeksternal.update', $ee->id_event_eksternal)}}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="kategori" class="form-control" id="">
                                            ...
                                            @if ($ee->kategori_id == $kategori->id_kategori)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="tipe_peserta" class="form-control" id="">
                                            ...
                                            @if ($ee->tipe_peserta_id == $tipe->id_tipe_peserta)
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="role" id="" class="form-control">
                                            @if ($ee->role == "Individu")
                                            <option selected value="{{$ee->role}}">{{$ee->role}}</option>
                                    ...
                                    <input type="hidden" name="oldBanner" value="{{$ee->banner_image}}">
                                    <input type="hidden" name="oldPoster" value="{{$ee->poster_image}}">
                            ...
                            <div class="col-lg-4 col-12">
                                <div class="border mb-3 ormawa-banner_inp_profil shadow-sm px-4 py-4 mt-2">
                                    <img data-filename="{{$eeJson}}"
                                        src="{{url('assets/img/kompetisi-thumb/'.$ee->poster_image)}}" id="poster-image"
                                        style="width: 100%" alt="" class="img-fluid">
                                </div>
                ...
                <div class="tab-pane fade" id="detail-event" role="tabpanel">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <p class="h5 text-orange" id="title-pembina"><i
                                        class="icon-copy dw dw-user-2 mr-2"></i>Status Validasi {{$ee->nama_event}}
                                </p>
                            </div>
                            <div class="col-6 text-right">
                                <div id="container-btn">
                        ...
                        <div class="col-12">
                            <form action="{{route('ormawa.eventeksternal.validasi.pembina')}}" method="post">
                                @csrf
                                @method('patch')
                                <input type="hidden" name="id_eed"
                                    value="{{$ee->pengajuanRef->id_event_eksternal_detail}}">
                                <div class="form-group">
                                    <label for="">Sudah Divalidasi Pembina</label>
                                    <select name="status" @if (Session::get('is_pembina')=="0" ) disabled @endif id=""
                                        class="form-control">
                                        @if ($ee->pengajuanRef->is_validated_pembina == 1)
                                        <option selected value="{{$ee->pengajuanRef->is_validated_pembina}}">Sudah
                                        </option>
                                        <option value="0">Belum</option>
                                        @else
                                        <option selected value="{{$ee->pengajuanRef->is_validated_pembina}}">Belum
                                        </option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select disabled id="" class="form-control">
                                        @if ($ee->pengajuanRef->is_validated_wadir3 == 1)
                                        <option selected value="{{$ee->pengajuanRef->is_validated_wadir3}}">Sudah
                                        </option>

                                        @else
                                        <option selected value="{{$ee->pengajuanRef->is_validated_wadir3}}">Belum
                                        </option>
                                        ...
                                        <div class="pd-20">
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-right">
                                                    @if (Session::get('is_pembina')=="0" )
                                                    <div id="container-btn">
                                                        <a onclick="uploadPengajuan({{$eeJson}})"
                                                            data-values="{{$eeJson}}" type="button"
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    @foreach ($feeps as $feep)
                                                    <div class="row mb-4"
                                                        id="tr_pengajuan_{{$feep->id_file_event_eksternal_detail }}">
                                                        <div class="col-10">
                                                            <div class="py-2 px-2"
                                                        ...
                                                        @php
                                                        $pengajuanJson = json_encode($feep);
                                                        @endphp
                                                        <div class="col-2 pt-2">
                                                            <a data-toggle="collapse"
                                                                href="#collapseExample_{{$feep->id_file_event_eksternal_detail }}"
                                                        ...
                                                        <div class="collapse col-12 mt-3"
                                                            id="collapseExample_{{$feep->id_file_event_eksternal_detail }}">
                                                            <div style="width: 100%; height:400px"
                                                                class="pengajuan-container border"
                                                                data-id="{{$feep->id_file_event_eksternal_detail}}"
                                                                data-filename="{{$feep->filename}}"
                                                                id="pengajuan_container_{{$feep->id_file_event_eksternal_detail}}">
                                        ...
                                        <div class="pd-20">
                                            <div class="row">
                                                ...
                                                <div class="col-6 text-right">
                                                    @if (Session::get('is_pembina')=="0" )
                                                    <div id="container-btn">
                                                        <a onclick="uploadPendaftaran({{$eeJson}})"
                                                            data-values="{{$eeJson}}" type="button"
                                                            id="tambah-pengajuan-btn"
                                                            class="dcd-btn dcd-btn-sm dcd-btn-primary mr-2 text-white"
                                                            style="border:none;padding:7px 20px;background: linear-gradient(60deg,#f5a461,#e86b32) !important">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    ...
                                                    <div class="row mb-4"
                                                        id="tr_pendaftaran_{{$feed->id_file_event_eksternal_detail }}">
                                                        <div class="col-10">
                                                            <div class="py-2 px-2"
                                                                style="width:100%; border-bottom:1px solid #fb8c00 !important;">
                                                                {{$feed->nama_file}}
                                                        ...
                                                        <div class="col-2 pt-2">
                                                            <a 
                                                                href="{{route('ormawa.eventeksternal.download.pendaftaran', $feed->id_file_event_eksternal_detail)}}"
                                                                class="text-orange d-inline mr-2" title="Download"
                                                                style="font-size:22px"><i
                                                                    class="icon-copy dw dw-download"></i></a>
                                                            @php
                                                            $pendaftaranJson = json_encode($feed);
                                                            @endphp
                                                            @if (Session::get('is_pembina')=="0" )
                                                            <a href="#"
                    ...
                    <div class="pd-20">
                        <div class="row mb-4">
                            <div class="col-12 text-right">
                                <div id="container-btn">
                                    <a href="#" id="tambah-tahapan-btn" onclick="addTahapan({{$ee->id_event_eksternal}})"
                                        class="dcd-btn dcd-btn-sm dcd-btn-primary mr-2"
                                        style="border:none;padding:7px 20px;background: linear-gradient(60deg,#f5a461,#e86b32) !important">
                                        Tambah</a>
                                </div>
                        ...
                        <table id="tahapan-table" class="stripe" style="width:100%">
                            ...
                            <tbody>
                                @foreach ($tahapans as $tahapan)
                                    <tr id="row_tahapan_{{$tahapan->id_tahapan_event_eksternal}}">
...
<div class="modal fade" id="upload-pengajuan-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('ormawa.eventeksternal.save.pengajuan')}}" enctype="multipart/form-data" method="post">
                @csrf
...
<div class="modal fade" id="upload-pendaftaran-modal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="{{route('ormawa.eventeksternal.save.pendaftaran')}}" enctype="multipart/form-data"
                method="post">
                @csrf
                <div class="modal-body">
                    <div class="row">
...
<script>
    ...
    const uploadPengajuan = (values) => {
        ...
        $('#id-inp').val(values.id_event_eksternal);
    } 
    ...
    const hapusBerkas = (values, type) => {
        ...
        let remove = "";
        if(type == "pendaftaran"){
            url = "/ormawa/eventeksternal/pendaftaran/detele/"+values.id_file_event_eksternal_detail ;
            remove = $('#tr_pendaftaran_' + values.id_file_event_eksternal_detail);
        }else{
            url = "/ormawa/eventeksternal/pengajuan/detele/"+values.id_file_event_eksternal_detail ;
            remove = $('#tr_pengajuan_' + values.id_file_event_eksternal_detail);
        }
            ...
            $.ajax(
                {
                    ...
                    dataType: "JSON",
                    data: {
                        "id_berkas": values.id_file_event_eksternal_detail
                    },
    ...
    const addTahapan = (id_eventeksternal) => {
        event.preventDefault();
        $('#eventid-inp').val(id_eventeksternal);
        $('#tahapan-event-form').attr('action','/ormawa/tahapan/eventeksternal/save'); 
        $('#tahapan-modal').modal('show');
    }

    const updateTahapan = (tahapan) => {
        event.preventDefault();
        $('#id-tahapan-inp').val(tahapan.id_tahapan_event_eksternal);
        $('#nama-tahapan-inp').val(tahapan.nama_tahapan);
        $('#tahapan-event-form').attr('action','/ormawa/tahapan/eventeksternal/update'); 
        $('#tahapan-modal').modal('show');
    }
    ...
    const deleteTahapan = (tahapans) => {
        ...
        var id_tahapan = tahapans.id_tahapan_event_eksternal;
        var url = "/ormawa/tahapan/eventeksternal/delete"
        Notiflix.Confirm.Show( 
