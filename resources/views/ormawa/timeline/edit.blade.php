                ...
                <div class="row">
                    ...
                    <div class="col-6 text-right">
                        <div id="container-btn">
                            <a href="{{route('ormawa.timeline.index')}}" id="tambah-btn"
                    ...
                    <div class="col-12">
                        <form action="{{route('ormawa.timeline.update', $type)}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <select class="js-example-basic-single" name="event_id" style="width: 100%">
                                    ...
                                    @elseif($type == "eventeksternal")
                                        ...
                                        @foreach ($ees as $ee)
                                            @if ($ee->id_event_eksternal != $tl->event_eksternal_id)
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="tgl_jadwal" value="{{$tl->tgl_jadwal}}" class="form-control"
                                    id="">
