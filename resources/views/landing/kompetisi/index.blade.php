                    ...
                    <div class="job-category-listing mb-50">
                        ...
                        <div class="single-listing">
                            <div class="small-section-tittle2">
                                <h4>Nama Kompetisi</h4>
                            </div>
                            <div class="input-form mb-4">
                                <input type="text" class="form-control" name="name" placeholder="Nama Kompetisi">
                            </div>
                            <div class="small-section-tittle2">
                                <h4>Kategori Kompetisi</h4>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <div class="count-job mb-35">
                                        <span>39, 782 Kompetisi Ditemukan</span>
                                        <!-- Select job items start -->
