                                        ...
                                        <div class="col-xs-12 ">
                                            <nav>
                                                <div class="nav nav-tabs nav-fill" id="nav-tab" role="tablist">
                                                    ...
                                                    <a class="nav-item nav-link"  href="{{route('kompetisi.timeline','Poster-Design-Competition')}}" role="tab" aria-selected="false">Timeline</a>
                                                </div>
                                            </nav>
                    ...
                    <div class="detail-komp__footer ">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-12 col-12 text-center mt-2">
                                <a href="{{route('kompetisi.registration.team', 'Poster-Design-Competition')}}" class="detail-komp__footer-btn">
                                    Daftar
                                </a>
                            </div>
                        </div>
