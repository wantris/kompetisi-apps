...
Route::group(['namespace' => 'peserta'], function () {
    ...
    Route::group(['middleware' => 'peserta', 'prevent-back-history'], function () {
        ...
        Route::group(['prefix' => 'account'], function () {
            ...
            Route::get('/registrasi/profile/{id_pengguna}', 'ProfileController@index')->name('peserta.account.profile.index');
